...
function AdminTheme() {
  ...
  const handleThemeSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post("/api/themes/upload", formData, {
  ...
  const handleDeactivateTheme = async (themeId) => {
    ...
    try {
      const { data } = await axios.put(`/api/themes/deactivate/${themeId}`);
  ...
  const handleActivateTheme = async (themeId) => {
    ...
    try {
      const { data } = await axios.put(`/api/themes/activate/${themeId}`);
      if (data.success) {
