...
function General() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("/api/theme-options", formData, {
  ...
  useEffect(() => {
    const generaldata = async () => {
      try {
        let response = await axios.get("/api/themeoptionsdata");
                  ...
                  src={
                    user.seo_og_image_url
                      ? user.seo_og_image_url.startsWith("blob:")
                        ? user.seo_og_image_url
                        : `/api/uploads/${user.seo_og_image_url}`
                      : Cutting
                  }
                  width="100"
                  height="100"
                  ...
                  src={
                    user.lazy_placeholder_image_url
                      ? user.lazy_placeholder_image_url.startsWith("blob:")
                        ? user.lazy_placeholder_image_url
                        : `/api/uploads/${user.lazy_placeholder_image_url}`
                      : user.lazy_placeholder_image
                      ? `/api/${user.lazy_placeholder_image}`
                      : Cutting
                  }
                  width="100"
                  height="100"
