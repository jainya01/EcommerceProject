...
function ThemeLogo() {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      const response = await axios.post("/api/update-settings", formData, {
        headers: {
                ...
                <div>
                  ...
                  >
                    {faviconUrl ? (
                      ...
                      <img
                        src={`/api/uploads/${user.favicon_url}`}
                        alt="RxLYTE"
                ...
                <div>
                  ...
                  >
                    {logoLightUrl ? (
                      ...
                      <img
                        src={`/api/uploads/${user.logo_light}`}
                        alt="RxLYTE"
