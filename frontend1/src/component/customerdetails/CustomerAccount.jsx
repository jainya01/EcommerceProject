...
function CustomerAccount() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`/api/userupdated/${id}`, detail);
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="http://localhost:5173/user/edit-account" />
      </Helmet>
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: password?.background_image
            ? `url(/api/${password.background_image})`
            : "none",
